...
public class SourceFileReaderTest {
	...
	public void testReadFileIntoListLocal() throws IOException {
		...
		List<String> actualList = sfr.readSourceFile("List", TEST_CLASS_LOCAL);
	...
	public void testReadFileIntoStringLocal() throws IOException {
		...
		sfr = new SourceFileReader(TYPE_LOCAL);
		String actuals = sfr.readSourceFile("String", TEST_CLASS_LOCAL);
				
		assertEquals(expectedString, actuals);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testReadFileIntoUnknownTypeLocal() throws IOException {
		//read a locally stored file into a String
		sfr = new SourceFileReader(TYPE_LOCAL);
		String actuals = sfr.readSourceFile("unknown", TEST_CLASS_LOCAL);
	...
	public void testReadFileIntoListWeb() throws IOException {
		...
		List<String> actualList = sfr.readSourceFile("List", TEST_CLASS_WEB);
	...
	public void testReadFileIntoStringWeb() throws IOException {
		...
		sfr = new SourceFileReader(TYPE_WEB);
		String actuals = sfr.readSourceFile("String", TEST_CLASS_WEB);
				
		assertEquals(expectedString, actuals);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testReadFileIntoUnknownTypeWeb() throws IOException {
		//read a locally stored file into a String
		sfr = new SourceFileReader(TYPE_WEB);
		String actuals = sfr.readSourceFile("unknown", TEST_CLASS_WEB);
	...
	public void testReadFileIntoListNull() throws IOException {
		...
		List<String> actualList = sfr.readSourceFile("List", "any-filepath");
	...
	public void testReadFileIntoStringNull() throws IOException {
		...
		sfr = new SourceFileReader("non-existing-type");
		String actualString = sfr.readSourceFile("String", "any-filepath");
